...
SendBufferRef CenterPacketCreator::GetMigrationSuccessResponse(const int32_t character_id, const int32_t auth_key) {
  CenterClientMigrationResponse packet;
...
SendBufferRef CenterPacketCreator::GetMigrationFailedResponse(int32_t character_id) {
  CenterClientMigrationResponse packet;
