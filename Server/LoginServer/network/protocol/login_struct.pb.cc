...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_login_5fstruct_2eproto::offsets[1] = {};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_login_5fstruct_2eproto = {
  false, false, 56, descriptor_table_protodef_login_5fstruct_2eproto, "login_struct.proto", 
  &descriptor_table_login_5fstruct_2eproto_once, descriptor_table_login_5fstruct_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_login_5fstruct_2eproto::offsets,
  nullptr, file_level_enum_descriptors_login_5fstruct_2eproto, file_level_service_descriptors_login_5fstruct_2eproto,
};
