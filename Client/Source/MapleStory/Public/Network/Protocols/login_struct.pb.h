...
inline ::protocol::PlayerType Player::_internal_type() const {
  return static_cast< ::protocol::PlayerType >(type_);
}
inline ::protocol::PlayerType Player::type() const {
  // @@protoc_insertion_point(field_get:protocol.Player.type)
  return _internal_type();
}
inline void Player::_internal_set_type(::protocol::PlayerType value) {
  
  type_ = value;
}
inline void Player::set_type(::protocol::PlayerType value) {
