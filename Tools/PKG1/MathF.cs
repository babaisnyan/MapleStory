...
/// <summary>
///     Provides single-precision floating Vector2 constants and static methods for trigonometric, logarithmic, and other
...
internal static class MathF
{
    ...
    /// </summary>
    /// <param name="f">
    ///     A number that is greater than or equal to <see cref="F:System.Single.MinValue" />, but less than or equal to
    ...
    ///     If <paramref name="f" /> is equal to <see cref="F:System.Single.NaN" />,
    ...
    /// <returns>
    ///     The cosine of <paramref name="f" />. If <paramref name="f" /> is equal to <see cref="F:System.Float.NaN" />,
    ///     <see cref="F:System.Float.NegativeInfinity" />,
    ...
    ///     If <paramref name="f" /> equals <see cref="F:System.Single.NaN" /> or
    ///     <see cref="F:System.Single.PositiveInfinity" />, that value is returned.
    ...
    ///     If <paramref name="val1" />, or <paramref name="val2" />, or both <paramref name="val1" /> and
    ///     <paramref name="val2" /> are
    ...
    ///     If <paramref name="val1" />, <paramref name="val2" />, or both <paramref name="val1" /> and
    ///     <paramref name="val2" /> are equal
    ...
    ///     If the fractional component of <paramref name="f" /> is halfway between two integers, one of which is even and the
    ...
    /// <returns>
    ///     The integer nearest <paramref name="f" />. If <paramref name="f" /> is halfway between two integers, one of which
    ///     is even
    ///     and the other odd, then <paramref name="mode" /> determines which of the two is returned.
    ///     Note that this method returns a <see cref="T:System.Single" /> instead of an integral type.
    /// </returns>
    /// <exception cref="T:System.ArgumentException">
    ///     <paramref name="mode" /> is not a valid value of <see cref="T:System.MidVector2Rounding" />.
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    private static int LeastCommonMultiple(params int[] factors)
    {
        return factors.Aggregate(1, LeastCommonMultiple);
    }
}
